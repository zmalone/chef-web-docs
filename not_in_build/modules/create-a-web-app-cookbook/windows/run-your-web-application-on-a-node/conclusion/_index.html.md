...
Next, we recommend that you [learn about automated testing](/modules/get-started-with-testing/). You'll learn how to use tools such as InSpec, ChefSpec, RuboCop, and Foodcritic to speed up the feedback loop even more by writing test code that automatically verifies whether your policy behaves as you expect.
