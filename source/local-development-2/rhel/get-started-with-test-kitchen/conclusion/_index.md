In this tutorial, you used Test Kitchen along with VirtualBox and Vagrant to configure a basic MOTD on a CentOS virtual machine, all from your workstation.

[GITHUB] [Get the reference implementation](https://github.com/learn-chef/motd-rhel/) for this tutorial on GitHub.
...
In the next tutorial, [Learn to manage a basic Red Hat Enterprise Linux web application](/manage-a-web-app/rhel/), you'll use the skills you've just learned to build a basic but complete web application that uses a web server, a database, and scripting. You'll learn how to leverage cookbooks that are written by the Chef community and resolve cookbook dependencies to create cookbooks that are more reusable.
