...
order: 1
---
In [Learn to manage a basic Red Hat Enterprise Linux web application](/manage-a-web-app/rhel), you built a basic but complete web application on Red Hat Enterprise Linux or CentOS that uses a web server, a database, and scripting.
