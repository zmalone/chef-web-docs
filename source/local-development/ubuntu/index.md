...
order: 1
---
In [Manage a web application](/manage-a-web-app/ubuntu), you built a basic but complete web application on Ubuntu that uses a web server, a database, and scripting.
