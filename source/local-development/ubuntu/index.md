...
order: 3
---
In [Manage an Ubuntu node](/tutorials/manage-a-node/ubuntu/), you built a basic web server configuration on Ubuntu. As part of the process, you set up a Chef server, brought up a node to manage, and bootstrapped your node.
