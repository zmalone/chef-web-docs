...
Recipe: code_generator::cookbook_file
  * directory[cookbooks/awesome_customers_rhel/files/default] action create
    - create new directory cookbooks/awesome_customers_rhel/files/default
  * template[cookbooks/awesome_customers_rhel/files/default/create-tables.sql] action create
    - create new file cookbooks/awesome_customers_rhel/files/default/create-tables.sql
    - update content in file cookbooks/awesome_customers_rhel/files/default/create-tables.sql from none to e3b0c4
...
```sql
-- ~/learn-chef/cookbooks/awesome_customers_rhel/files/default/create-tables.sql
