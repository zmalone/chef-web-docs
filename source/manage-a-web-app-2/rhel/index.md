...
After you've successfully verified the complete web application locally, you'll set up a node to bootstrap, upload your cookbook to the Chef server, bootstrap your node, and apply your web server configuration.
