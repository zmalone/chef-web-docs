...
In [Manage a node](/manage-a-node/ubuntu/), you bootstrapped a node that we provided. Now it's time to bootstrap a node that you own to give you experience working with your own infrastructure.
