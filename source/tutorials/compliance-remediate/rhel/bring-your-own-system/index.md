---
title: 'Remediate compliance failures on Red Hat Enterprise Linux'
...
order: 1
---
In the previous tutorial, [Scan for compliance](/tutorials/compliance-assess/rhel/), you set up a Chef compliance scanner server and scanned a CentOS 7 server against the predefined CIS Security Benchmarks.
