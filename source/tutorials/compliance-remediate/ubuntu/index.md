...
order: 2
---
In the previous tutorial, [Assess your infrastructure with the Chef compliance scanner](/tutorials/compliance-assess/ubuntu/), you set up a Chef compliance scanner server and scanned an Ubuntu 14.04 server against the predefined CIS Security Benchmarks.
